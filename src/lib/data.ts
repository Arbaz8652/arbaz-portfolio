...
export const getProjects = (): Project[] => [
  {
    title: 'Bureau Microservice',
    description: 'Centralized microservice for fetching, processing, and storing credit bureau data securely across multiple platforms.',
    problem: 'Duplicate bureau logic was maintained across multiple backend systems, leading to redundancy, inconsistency, and higher maintenance cost.',
    solution: 'Designed and built a standalone microservice with secure x-api-key authentication, IP whitelisting, and encryption for sensitive data. Integrated both Novio and Credilio platforms to consume bureau data from this service.',
    result: 'Eliminated code duplication, improved data consistency, enhanced security, and simplified future integrations.',
    tech: ['Node.js', 'AdonisJS', 'PostgreSQL', 'Kafka', 'Redis'],
    icon: Server,
    github: '#',
    live: '#'
  },
  {
    title: 'Credilio D2C Backend Platform',
    description: 'Backend system powering a direct-to-consumer credit card sales and onboarding platform.',
    problem: 'Manual content updates and tightly coupled backend logic slowed product changes and increased operational effort.',
    solution: 'Built scalable REST APIs with backend-driven dynamic configuration, secure authentication, and optimized database queries to support flexible UI rendering.',
    result: 'Enabled faster product updates, reduced manual maintenance, and improved overall system scalability and reliability.',
    tech: ['Node.js', 'TypeScript', 'AdonisJS', 'PostgreSQL', 'Redis'],
    icon: Database,
    github: '#',
    live: '#'
  },
  {
    title: 'Third-Party API Monitoring & Reporting System',
    description: 'Monitoring and reporting system for high-volume third-party banking API integrations.',
    problem: 'Frequent third-party API failures were hard to detect and diagnose, impacting customer journeys and business metrics.',
    solution: 'Implemented event-based monitoring using Node.js events and New Relic, along with optimized report generation using streams and AWS S3.',
    result: 'Improved API reliability, reduced failures, and achieved ~60% CPU and ~50% memory optimization in report generation.',
    tech: ['Node.js', 'New Relic', 'AWS S3', 'PostgreSQL', 'Kafka'],
    icon: Zap,
    github: '#',
    live: '#'
  }
